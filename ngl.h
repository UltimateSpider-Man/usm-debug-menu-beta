...
void __cdecl sub_FC4D50(float a1)
{
    nglCurScene()->field_364 = a1;
}
...
void nglSetClearFlags(int a1)
{
    nglCurScene()->field_39C = a1;
}

void sub_FDC0A0(nglFont* arg0, float arg4, float a3, float a5, const char* a2)
{
    char a1[1024];
    char v6;

    printf(a1, a2, &v6);
    nglListAddString(arg0, a1, arg4, a3, a5, -1, 1.0, 1.0);
}
...
{
    if (nglSyncDebug().DisableScratch == 1) {
